...
def afficherLesSalles():
    ...
    """
    rowsSalles =db(db.salle.categorie_id==db.categorie.id).select(db.salle.id,db.categorie.heureOuvertureMinutes,db.categorie.heureOuverture,db.salle.nom,db.categorie.nom) #requête permettant de récupérer les informations des salles
