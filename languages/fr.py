...
"Buy web2py's book": 'Acheter le livre web2py',
'cache': 'cache',
'Cache': 'Cache',
...
'Database Administration (appadmin)': 'Administration de la base de données (appadmin)',
'db': 'bdd',
'DB Model': 'Modèle BDD',
'Delete:': 'Supprimer:',
'Demo': 'Démo',
...
'Invalid login': 'Informations de connexion incorrects',
...
'Live Chat': 'Chat en direct',
'Log In': 'Connexion',
'Log Out': 'Deconnnexion',
'Logged in': 'Connecté',
'Logged out': 'Deconnecté',
'login': 'se connecter',
'Login': 'Se connecter',
